...
export default function FinalModal({ score, total, xp, onNext, onRestart, isLastEpisode }) {
  ...
  useEffect(() => {
    ...
    if (percentage >= 70) {
      ...
      const frame = () => {
        confetti({ particleCount: 3, angle: 60, spread: 55, origin: { x: 0 }, colors: ['#E50914', '#ffffff', '#F59E0B'] })
        confetti({ particleCount: 3, angle: 120, spread: 55, origin: { x: 1 }, colors: ['#E50914', '#ffffff', '#F59E0B'] })
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mb-8 relative z-10">
          <div className="bg-white/5 rounded-2xl p-4 border border-white/5">
            ...
            <p className="text-3xl font-bold text-white flex items-baseline justify-center gap-1 tabular-nums">
          ...
          <div className="bg-[#E50914]/10 rounded-2xl p-4 border border-[#E50914]/20">
            ...
            <p className="text-3xl font-bold text-[#E50914] tabular-nums">+{displayXP}</p>
          </div>
        </div>
